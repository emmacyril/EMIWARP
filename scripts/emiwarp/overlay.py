...
parser but cannot reach it — requests to Warp-operated hosts fail closed."#''',
    ...
    Injection(
        ident="brand-warpify-desc",
        path="app/src/settings_view/warpify_page.rs",
        anchor='                "Configure whether Warp attempts to “Warpify” (add support for blocks, \\',
        mode="replace",
        payload='                "Configure whether EmiWarp attempts to “Warpify” (add support for blocks, \\',
        guard='whether EmiWarp attempts',
        why="Rebrand the Warpify page description.",
    ),
    Injection(
        ident="brand-drive-sync",
        path="app/src/settings_view/execution_profile_view.rs",
        anchor='                                "Auto-sync plans to Warp Drive:",',
        mode="replace",
        payload='                                "Auto-sync plans to cloud storage:",',
        guard='"Auto-sync plans to cloud storage:"',
